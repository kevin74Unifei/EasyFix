...
<fieldset>
            <legend>Contato:</legend>
                <div class="form-group">
                    ...
                    <input type="email" size="78" class="form-control" 
                           value="{{$resp["email"] or ""}}" name="{{$ent or "ent"}}_email">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="campoTelefoneCel" 
                           autocomplete="off" name="{{$ent or "ent"}}_telefoneCel" 
                           value="{{$resp["telefoneCel"] or ""}}" pattern="\([0-9]{2}\) [0-9]{1}-[0-9]{4,6}-[0-9]{3,4}$" >
                </div>
</fieldset>
